...
/**
 * Question class to hold all of the necessary information for each quiz
 * question.
 * 
 * @author Ben Zerler
 */
public class Question {
	 ...
	 */
	public Question(String questionText, ArrayList<String> choices, String answer, String topic, String filePath) {
